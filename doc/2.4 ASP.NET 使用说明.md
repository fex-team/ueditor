...
UEditor 在 1.4 版本之后进行了一次[前后端统一配置](3.3 后端请求规范.md)的整理，.Net 的后台也进行了一次重写，跟之前的版本差别较大，升级的用户注意阅读本文档。
...
![检查 .NET 4.0 安装情况](images/net-publish-1.png)
