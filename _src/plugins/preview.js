...
UE.commands['preview'] = {
    execCommand : function(){
        ...
        d.write('<html><head><script src="'+this.options.UEDITOR_HOME_URL+'uparse.js"></script><script>' +
            ...
            "    'formulaCssUrl':'"+this.options.UEDITOR_HOME_URL+"third-party/mathquill-0.9.1/mathquill.css'," +
            "    'jqueryUrl':'"+this.options.UEDITOR_HOME_URL+"third-party/mathquill-0.9.1/jquery-1.8.3.min.js'," +
            "    'formulaJsUrl':'"+this.options.UEDITOR_HOME_URL+"third-party/mathquill-0.9.1/mathquill.min.js'" +
            "})},300)" +
