...
//        ]
        , toolbars: [
            [ 'undo', 'redo', '|', 'bold', 'italic', 'underline', 'forecolor', 'backcolor', '|', 'fontsize', 'fontfamily', '|', 'paragraph', '|', 'insertimage', '|', 'justifyleft', 'justifycenter', 'justifyright', 'imageleft', 'imageright', '|', 'autotypeset', 'indent', 'noindent', '|', 'pagebreak', 'spechars', 'searchreplace', '|', 'merge', 'remark', 'fullscreenmark' ]
        ]

        //文库自动转换className前缀
        ,CLASS_NAME_PREFIX: 'ext_'
...
//        ,maxListLevel : 3 //限制可以tab的级数-1不限制
        ...
        ,'fontfamily':[
            { label:'宋体',name:'songti',value:'宋体,SimSun'},
            { label:'楷体',name:'kaiti',value:'楷体,楷体_GB2312, SimKai'},
            { label:'微软雅黑',name:'yahei',value:'微软雅黑,Microsoft YaHei'},
            { label:'黑体',name:'heiti',value:'黑体, SimHei'},
            { label:'默认字体',name:'',value:''}
        ]

        //fontsize
        //字号
        ,'fontsize':[
            {label:'1号', name:'1', value:'24px' },
            {label:'2号', name:'2', value:'20px' },
            {label:'3号', name:'3', value:'16px' },
            {label:'4号', name:'4', value:'14px' },
            {label:'5号', name:'5', value:'12px' },
            {label:'6号', name:'6', value:'10px' },
            {label:'默认字号', name:'', value:'' }
        ]

        //paragraph
        //段落格式 值留空时支持多语言自动识别，若配置，则以配置值为准
        ,'paragraph':{'p':'', 'h2':'', 'h3':'', 'h4':'' , 'blockquote': '', 'inscribed': '' }
