            ...
            if (editor.options.imagePopup) {
                ...
                editor.addListener('selectionchange', function (t, causeByUi) {
                    ...
                    if (img && img.tagName == 'IMG') {
                        ...
                        if (img.getAttribute("data-remark")) {
                            dialogName = "remarkDialog"
                        }
                        ...
                        str = '<nobr>' + editor.getLang("property") + ': '+
                            ...
                            '<span onclick=$$._onImgSetFloat("left") class="edui-clickable">' + editor.getLang("insertimage.floatLeft") + '</span>&nbsp;&nbsp;' +
                            '<span onclick=$$._onImgSetFloat("right") class="edui-clickable">' + editor.getLang("insertimage.floatRight") + '</span>&nbsp;&nbsp;' +
