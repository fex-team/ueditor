...
(function () {
    ...
    var iframeUrlMap = {
       ...
       //'highlightcode':'~/dialogs/highlightcode/highlightcode.html',
        ...
        'remark':'~/dialogs/remark/remark.html'
    };
    ...
    var btnCmds = ['undo', 'redo', 'formatmatch', 'merge',
        ...
        'deletecol', 'splittorows', 'splittocols', 'splittocells', 'mergecells', 'deletetable', 'fullscreenmark'];
    ...
    var dialogBtns = {
        ...
        ok:['attachment', 'anchor', 'link', 'insertimage', 'map', 'gmap', 'insertframe', 'insertimagetype', 'wordimage',
            'insertvideo', 'insertframe', 'edittip', 'edittable', 'edittd', 'scrawl', 'template', 'music', 'remark']
