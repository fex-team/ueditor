...
if (! _$jscoverage['plugins/template.js']) {
  ...
  _$jscoverage['plugins/template.js'][14] = 0;
  _$jscoverage['plugins/template.js'][15] = 0;
  _$jscoverage['plugins/template.js'][17] = 0;
...
UE.plugins.template = (function () {
  ...
  _$jscoverage['plugins/template.js'][14]++;
  this.addListener("click", (function (type, evt) {
  _$jscoverage['plugins/template.js'][15]++;
  var el = (evt.target || evt.srcElement), range = this.selection.getRange();
  _$jscoverage['plugins/template.js'][17]++;
  ...
  _$jscoverage['plugins/template.js'][25]++;
  var range = this.selection.getRange();
  _$jscoverage['plugins/template.js'][26]++;
  if ((! range.collapsed)) {
    _$jscoverage['plugins/template.js'][27]++;
    if (((! evt.ctrlKey) && (! evt.metaKey) && (! evt.shiftKey) && (! evt.altKey))) {
      _$jscoverage['plugins/template.js'][28]++;
      var tnode = domUtils.findParent(range.startContainer, (function (node) {
  _$jscoverage['plugins/template.js'][29]++;
  if ((node.className && domUtils.hasClass(node, "ue_t"))) {
    _$jscoverage['plugins/template.js'][30]++;
    return node;
  }
}), true);
      _$jscoverage['plugins/template.js'][33]++;
      if (tnode) {
        _$jscoverage['plugins/template.js'][34]++;
