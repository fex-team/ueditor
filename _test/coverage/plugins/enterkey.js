...
if (! _$jscoverage['plugins/enterkey.js']) {
  ...
  _$jscoverage['plugins/enterkey.js'][77] = 0;
  ...
  _$jscoverage['plugins/enterkey.js'][87] = 0;
  _$jscoverage['plugins/enterkey.js'][88] = 0;
  _$jscoverage['plugins/enterkey.js'][90] = 0;
  _$jscoverage['plugins/enterkey.js'][93] = 0;
  _$jscoverage['plugins/enterkey.js'][95] = 0;
  _$jscoverage['plugins/enterkey.js'][97] = 0;
  _$jscoverage['plugins/enterkey.js'][101] = 0;
  _$jscoverage['plugins/enterkey.js'][102] = 0;
  _$jscoverage['plugins/enterkey.js'][103] = 0;
  _$jscoverage['plugins/enterkey.js'][106] = 0;
  _$jscoverage['plugins/enterkey.js'][109] = 0;
  _$jscoverage['plugins/enterkey.js'][111] = 0;
  _$jscoverage['plugins/enterkey.js'][115] = 0;
...
UE.plugins.enterkey = (function () {
  ...
  if ((keyCode == 13)) {
    ...
    _$jscoverage['plugins/enterkey.js'][77]++;
    setTimeout((function () {
  ...
  if ((keyCode == 13)) {
    _$jscoverage['plugins/enterkey.js'][87]++;
    if (me.undoManger) {
      _$jscoverage['plugins/enterkey.js'][88]++;
      me.undoManger.save();
    }
    _$jscoverage['plugins/enterkey.js'][90]++;
    hTag = "";
    _$jscoverage['plugins/enterkey.js'][93]++;
    var range = me.selection.getRange();
    _$jscoverage['plugins/enterkey.js'][95]++;
    if ((! range.collapsed)) {
      _$jscoverage['plugins/enterkey.js'][97]++;
      ...
      _$jscoverage['plugins/enterkey.js'][101]++;
    ...
    _$jscoverage['plugins/enterkey.js'][106]++;
    if ((tag == "p")) {
      _$jscoverage['plugins/enterkey.js'][109]++;
      if ((! browser.ie)) {
        _$jscoverage['plugins/enterkey.js'][111]++;
        start = domUtils.findParentByTagName(range.startContainer, ["ol", "ul", "p", "h1", "h2", "h3", "h4", "h5", "h6", "blockquote", "caption"], true);
        _$jscoverage['plugins/enterkey.js'][115]++;
        if (((! start) && (! browser.opera))) {
          ...
          hTag = start.tagName;
          _$jscoverage['plugins/enterkey.js'][128]++;
      ...
      if ((! range.collapsed)) {
        _$jscoverage['plugins/enterkey.js'][137]++;
        range.deleteContents();
        _$jscoverage['plugins/enterkey.js'][138]++;
        start = range.startContainer;
        _$jscoverage['plugins/enterkey.js'][139]++;
        if (((start.nodeType == 1) && (start = start.childNodes[range.startOffset]))) {
          _$jscoverage['plugins/enterkey.js'][140]++;
          while ((start.nodeType == 1)) {
            _$jscoverage['plugins/enterkey.js'][141]++;
            if (dtd.$empty[start.tagName]) {
              ...
              _$jscoverage['plugins/enterkey.js'][146]++;
              return false;
            }
            _$jscoverage['plugins/enterkey.js'][148]++;
            if ((! start.firstChild)) {
              _$jscoverage['plugins/enterkey.js'][149]++;
              var br = range.document.createElement("br");
              _$jscoverage['plugins/enterkey.js'][150]++;
              start.appendChild(br);
              _$jscoverage['plugins/enterkey.js'][151]++;
              ...
              _$jscoverage['plugins/enterkey.js'][155]++;
              return false;
            }
            _$jscoverage['plugins/enterkey.js'][157]++;
          ...
          if ((start === range.startContainer.childNodes[range.startOffset])) {
            ...
            _$jscoverage['plugins/enterkey.js'][164]++;
            range.setStart(start, 0).setCursor();
          }
        }
        else {
          _$jscoverage['plugins/enterkey.js'][169]++;
          br = range.document.createElement("br");
          _$jscoverage['plugins/enterkey.js'][170]++;
          range.insertNode(br).setStartAfter(br).setCursor();
        }
      }
      else {
        _$jscoverage['plugins/enterkey.js'][175]++;
        br = range.document.createElement("br");
        _$jscoverage['plugins/enterkey.js'][176]++;
        range.insertNode(br);
        _$jscoverage['plugins/enterkey.js'][177]++;
        var parent = br.parentNode;
        _$jscoverage['plugins/enterkey.js'][178]++;
        if ((parent.lastChild === br)) {
          _$jscoverage['plugins/enterkey.js'][179]++;
          br.parentNode.insertBefore(br.cloneNode(true), br);
          _$jscoverage['plugins/enterkey.js'][180]++;
          range.setStartBefore(br);
        }
        else {
          _$jscoverage['plugins/enterkey.js'][182]++;
          range.setStartAfter(br);
        }
        _$jscoverage['plugins/enterkey.js'][184]++;
        range.setCursor();
      }
    }
  }
