...
test( '选中多个单元格插入超链接', function () {
    ...
    setTimeout(function(){
        ...
        equal( ua.getChildHTML( trs[0].cells[0] ), '<a href="http://www.baidu.com/">http://www.baidu.com/</a>', '第一个单元格中插入超链接' );
...
test( '去除表格中的链接', function () {
    ...
    setTimeout(function(){
        ...
        editor.execCommand( 'unlink' );
        equal( ua.getChildHTML( trs[0].cells[0] ), 'http://www.baidu.com/', '第一个单元格中插入超链接' );
        equal( ua.getChildHTML( trs[0].cells[1] ), br, '第二个单元格中未插入超链接' );
