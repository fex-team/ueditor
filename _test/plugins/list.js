...
test('回车将p转成列表', function () {
    ...
    stop();
    setTimeout(function () {
        var textContent = editor.body.firstChild.childNodes;
        range.setStart(textContent[textContent.length-1],textContent[textContent.length-1].length).collapse(true).select();
