...
test('检查取得word_img的url地址', function () {
    ...
    setTimeout(function () {
        ...
        equal(editor.word_img[0], "file:///C:DOCUME~1DONGYA~1LOCALS~1Tempmsohtmlclip1clip_image001.gif", '检查url地址');
        ...
        setTimeout(function () {
            ...
            equal(editor.word_img[0], "file:///C:\DOCUME~1\DONGYA~1\LOCALS~1\Temp\msohtmlclip1\01\clip_image001.jpg", '检查 第一个url地址');
...
test('多实例编辑器检查取得word_img的url地址', function () {
    ...
    var editor1 = new UE.Editor({'initialContent':'<p><span style="font-size:14px;font-family:&#39;times new roman&#39;, serif"><img width="172px" height="111px" src="/ge/ueditor_1_2_0_0_BRANCH/themes/default/images/spacer.gif" word_img="file:///C:\DOCUME~1\DONGYA~1\LOCALS~1\Temp\msohtmlclip1\01\clip_image001.gif" style="background:url(/ge/ueditor_1_2_0_0_branch/themes/default/images/localimage.png) no-repeat center center;border:1px solid #ddd" /></span><br /></p><p><span style="font-size:14px;font-family:&#39;times new roman&#39;, serif"><img src="http://img.baidu.com/hi/jx2/j_0001.gif" border="0" hspace="0" vspace="0" /><br /> </span></p>', 'autoFloatEnabled':false});
